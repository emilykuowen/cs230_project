...
def train(output_folder, batch_size, max_epochs, epoch_length):    
    ...
    condition = np.load("../ddsp/harmonic_distribution_output/drums_harmonic_distribution.npy")
...
def plot_validation_loss(filepath, output_path):
    ...
    plt.title('L1 Loss of Drum Separator Model with Conditioning')
...
if __name__ == "__main__":
    ...
    output_path = 'drum_conditioning_output/'
    output_folder = Path(output_path).absolute()
